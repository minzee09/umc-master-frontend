...
export const daejeonDistricts = [
    { value: "default", label: "시 · 군 · 구" },
    { value: "joong", label: "중구" },
    { value: "dong", label: "동구" },
    { value: "seong", label: "서구" },
    { value: "yuseong", label: "유성구" },
    { value: "daedeok", label: "대덕구" },
];
  
export const gwangjuDistricts = [
    { value: "default", label: "시 · 군 · 구" },
    { value: "dong", label: "동구" },
    { value: "nam", label: "남구" },
    { value: "buk", label: "북구" },
...
export const sejongDistricts = [
    { value: "default", label: "시 · 군 · 구" },
    { value: "jocheon", label: "조치원" },
    { value: "sejong", label: "세종시" },
];
  
export const gyeonggiDistricts = [
    { value: "default", label: "시 · 군 · 구" },
...
export const chungcheongbukDistricts = [
    { value: "default", label: "시 · 군 · 구" },
...
export const chungcheongnamDistricts = [
    { value: "default", label: "시 · 군 · 구" },
...
export const jeollabukDistricts = [
    { value: "default", label: "시 · 군 · 구" },
...
export const jeollanamDistricts = [
    { value: "default", label: "시 · 군 · 구" },
...
export const gyeongsangbukDistricts = [
    { value: "default", label: "시 · 군 · 구" },
    ...
    { value: "ullung", label: "울릉군" }
];
  
export const gyeongsangnamDistricts = [
    { value: "default", label: "시 · 군 · 구" },
